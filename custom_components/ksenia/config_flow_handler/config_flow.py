"""Config flow for ksenia — user setup, reconfigure and reauth."""

from typing import Any

from custom_components.ksenia.api import KSeniaLaresApiClientAuthenticationError, KSeniaLaresApiClientCommunicationError
...
class KSeniaLaresConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle the config flow for ksenia."""
    ...
    async def _async_validate(self, user_input: dict[str, Any]) -> dict[str, str]:
        ...
        except KSeniaLaresApiClientAuthenticationError:
            return {"base": "invalid_auth"}
        except KSeniaLaresApiClientCommunicationError:
