...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        KSeniaLaresApiClientAuthenticationError: For 401 and 403 responses.
...
class KSeniaLaresApiClient:
    ...
    async def _api_wrapper(
        ...
        Raises:
            ...
            KSeniaLaresApiClientCommunicationError: If the request does not complete.
            KSeniaLaresApiClientError: For any other failure.
